...
//       return data;
// }
// const data = await caricuaca("Jakarta");
// console.log(data);
// --------------
...
const getWeatherForecast = async (cityName) => {
  try {
    const response = await fetch(`https://weatherapi-com.p.rapidapi.com/forecast.json?q=${cityName}&days=3`, {
      ...
      headers: {
        "x-rapidapi-host": "weatherapi-com.p.rapidapi.com",
        "x-rapidapi-key": "fb47c3233mshd0d2beb4d5d4ad9p102022jsn6bb48673b1ff"
      },
    });
    const data = await response.json();
    console.log(data);
